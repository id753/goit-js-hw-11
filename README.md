...
HTTP-запити. Додано у проєкт бібліотеку Axios для написання коду, пов’язаного з HTTP-запитами.

Для бекенду використано публічний API сервіс Pixabay https://pixabay.com/api/docs/. 

Для показу повідомлень використано бібліотеку iziToast https://github.com/marcelodolza/iziToast. 

Додано відображення великої версії зображення з бібліотекою SimpleLightbox https://github.com/andreknieriem/simplelightbox для повноцінної галереї.

Індикатор завантаження. Використано бібліотеку з гарними індикаторами завантаження css-loader https://github.com/vineethtrv/css-loader. 
